...
parser = argparse.ArgumentParser(description='SCTN')
...
if __name__ == '__main__':
    ...
    net = SCTN(Ks, Kt, blocks, num_timesteps_input, n_route, drop_prob, num_timesteps_output, training_input.shape[1], A, n_days).to(args.device)
